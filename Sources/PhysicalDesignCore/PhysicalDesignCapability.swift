...
public struct PhysicalDesignCapability: Sendable, Hashable, Codable {
    ...
    public init(engineID: String, contractVersion: Int, supportedInputFormats: [ArtifactFormat], supportedOutputFormats: [ArtifactFormat], features: [String], limitations: [String]) {
