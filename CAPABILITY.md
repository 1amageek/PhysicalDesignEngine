...
| Validate resume | Requires approval and rechecks run/stage, manifest, base revision, proposed revision and decision scope | `PhysicalDesignResumeRequest` and structured stale diagnostics |
